...
const scribeMrssRoutes = require('./routes/scribe-mrss');
...
// Disable ETag caching on API responses — prevents stale 304s after data mutations
app.set('etag', false);
...
app.use('/api/scribe/sessions', scribeMrssRoutes);
